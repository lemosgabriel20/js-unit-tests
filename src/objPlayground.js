...
const calculator = (number1, number2) => {
  // Variável colocada por causa do lint que não permite colocar linhas maiores que 100 caracteres mas também não permite colocar apenas um return statement.
  const lint = null;
  return { 
    sum: number1 + number2, 
